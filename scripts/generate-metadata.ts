...
- "description": Stutt, einlæg kynning á ${input.language === 'en' ? 'English' : 'íslensku'} sem fær áhorfandann til að vilja horfa, ekki útdráttur. 2-4 setningar (um 50-90 orð). Láttu þrennt koma fram, en ALDREI í fastri formúlu og með ólíku upphafi í hvert sinn: (1) hvað þátturinn fjallar raunverulega um, áþreifanlega, og hver kennir ef það skiptir máli; (2) þörfina, spurninguna eða þrána í lífi áhorfandans sem þátturinn snertir; (3) hvað áhorfandinn ber með sér: sannleika, huggun, hvatningu eða raunhæft skref, og hvert það vísar (oft til vonar og Krists). Fyrsta setningin verður að virka ein og sér sem krókur (hún birtist oft ein á spjaldi). Ávarp í 2. persónu ("þú") er velkomið. Vertu áþreifanlegur og hreinskilinn, hlýr en aldrei uppskrúfaður. Bannað: klisjur, markaðsorð, uppskrúfuð lýsingarorð (kraftmikill, einstakur, magnaður) og formúluupphöf eins og "Í þessum þætti" / "Í þessum kraftmikla þætti". Sérhver lýsing á að geta staðið ein og hljómað eins og manneskja, ekki vél.
