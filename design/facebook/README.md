...
| Cover photo | `omega-cover.png` (1640×720) | Page → cover photo. Designed to survive both desktop (820×312) and mobile (640×360) crops. Don't reposition; leave centered. |
...
> Kristilegt sjónvarp fyrir Ísland síðan 1992. Beint streymi, þættir, orð dagsins og bænatorg á omega.is. Rás 6 hjá Símanum.

**About (long / additional info):**

> Omega hefur sent út kristilegt sjónvarp fyrir Ísland síðan 1992. Á omega.is finnur þú beint streymi, nýjustu þættina, orð dagsins og Bænatorgið, þar sem beðið er fyrir hverri bæn sem berst. Sjónvarpið er á rás 6 hjá Símanum og hjá Vodafone.
