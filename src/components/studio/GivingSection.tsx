...
.give-grid{display:grid;grid-template-columns:1fr 460px;gap:clamp(32px,4vw,56px);align-items:end}
...
.give-prog .cols{display:flex;align-items:flex-end;gap:12px;height:150px;margin-top:20px;max-width:460px}
